...
#CTCGFW
git clone -b master --depth 1 https://github.com/immortalwrt/packages.git ../immortalwrt && mkdir -p diy/ctcgfw && rm -rf ../immortalwrt/.git && \
[ -e ../immortalwrt/net/adguardhome/Makefile ] && rm -rf diy/ctcgfw/adguardhome && mv ../immortalwrt/net/adguardhome diy/ctcgfw && echo "adguardhome更新成功" || echo "adguardhome暂无更新"
